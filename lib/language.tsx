...
const translations: Translations = {
  en: {
    ...
    hero_subtitle: "Build your CV with AI or voice, apply to 50+ companies in one click, and let smart matching find your perfect job. For HR: bulk import CVs, AI interviews, and an intelligent recruiting assistant.",
    enter_app: "Enter App",
    ...
    ai_cv_builder_desc: "Build by typing, uploading, or just talking. AI extracts everything.",
    instant_parsing: "Smart Vision Parsing",
    instant_parsing_desc: "Upload any PDF—even scanned documents. AI reads and extracts everything.",
    ...
    students: "Students",
    students_desc: "Build your CV with AI, voice recording, or upload. Get smart job matches, one-click apply, and direct messaging with employers.",
    ai_cv_improvements: "Voice-to-CV & AI Builder",
    browse_jobs: "Smart job matching",
    multi_company_apply: "One-click apply",
    start_as_student: "Start as Student",
    hr_teams: "HR Teams",
    hr_teams_desc: "Bulk import CVs, run AI-powered interviews, manage inbox conversations, and let AI find your best candidates instantly.",
    post_job_openings: "Bulk CV import",
    ai_recruiting_agent: "AI recruiting assistant",
    track_applications: "AI video interviews",
    ...
    browse_latest_openings: "Browse the latest job openings from top companies",
    search_jobs: "Search jobs...",
    location: "Location",
    all_locations: "All Locations",
    job_type: "Job Type",
    all_job_types: "All Types",
    full_time: "Full-time",
    part_time: "Part-time",
    contract: "Contract",
    ...
    info_we_collect: "1. Information We Collect",
    info_we_collect_desc: "We collect information you provide directly to us, such as:",
    personal_info_item: "Personal information (name, email, phone number)",
    cv_data_item: "CV and resume data",
    education_work_item: "Educational background and work experience",
    skills_interests_item: "Skills and professional interests",
    how_we_use: "2. How We Use Your Information",
    how_we_use_desc: "We use the information we collect to:",
    career_matching_item: "Provide career matching and job recommendation services",
    process_cv_item: "Process and store your CV submissions",
    communicate_item: "Communicate with you about opportunities",
    improve_services_item: "Improve our services and user experience",
    data_retention: "3. Data Retention",
    data_retention_desc: "We retain your personal information for 12 months from the date of submission, or until you request deletion, whichever comes first.",
    your_rights: "4. Your Rights",
    your_rights_desc: "Under Kuwait's data protection regulations, you have the right to:",
    access_info_item: "Access your personal information",
    correct_info_item: "Correct inaccurate information",
    delete_data_item: "Request deletion of your data",
    export_data_item: "Export your data in a portable format",
    security: "5. Security",
    security_desc: "We implement appropriate technical and organizational measures to protect your personal information against unauthorized access, alteration, disclosure, or destruction.",
    contact_us: "6. Contact Us",
    contact_privacy_desc: "If you have questions about this Privacy Policy, please contact support@careerly.com.",
    
    // Terms of Service
    terms_of_service_title: "Terms of Service",
    acceptance_of_terms: "1. Acceptance of Terms",
    acceptance_desc: "By accessing and using Wathefni AI, you accept and agree to be bound by the terms and provision of this agreement.",
    use_license: "2. Use License",
    use_license_desc: "Permission is granted to temporarily use Wathefni AI for personal, non-commercial transitory viewing only.",
    data_usage: "3. Data Usage",
    data_usage_desc: "Your CV and personal information are processed for career matching and job recommendation purposes. Data is retained for 12 months and accessible only to authorized staff.",
    privacy_section: "4. Privacy",
    privacy_section_desc: "Your privacy is important to us. Please review our Privacy Policy, which also governs your use of the service.",
    contact_information: "5. Contact Information",
    contact_terms_desc: "If you have any questions about these Terms of Service, please contact support@careerly.com.",
    ...
    your_email_placeholder: "you@example.com",
    make_sure_cv_uploaded: "Make sure you've uploaded your CV first",
    ...
    application_success_msg: "Your application has been submitted successfully. We'll be in touch soon!",
    close: "Close",
  ...
  ar: {
    ...
    hero_subtitle: "أنشئ سيرتك الذاتية بالذكاء الاصطناعي أو الصوت، قدّم لأكثر من 50 شركة بنقرة واحدة، ودع المطابقة الذكية تجد وظيفتك المثالية. للموارد البشرية: استيراد جماعي للسير الذاتية، مقابلات ذكية، ومساعد توظيف ذكي.",
    ...
    ai_cv_builder_desc: "أنشئ بالكتابة أو الرفع أو التحدث. الذكاء الاصطناعي يستخرج كل شيء.",
    instant_parsing: "تحليل ذكي بالرؤية",
    instant_parsing_desc: "ارفع أي PDF—حتى المستندات الممسوحة. الذكاء الاصطناعي يقرأ ويستخرج كل شيء.",
    ...
    students: "الطلاب",
    students_desc: "أنشئ سيرتك الذاتية بالذكاء الاصطناعي أو التسجيل الصوتي أو الرفع. احصل على مطابقة وظائف ذكية، تقديم بنقرة واحدة، ورسائل مباشرة مع أصحاب العمل.",
    ai_cv_improvements: "صوت إلى سيرة ذاتية ومنشئ ذكي",
    browse_jobs: "مطابقة وظائف ذكية",
    multi_company_apply: "تقديم بنقرة واحدة",
    start_as_student: "ابدأ كطالب",
    hr_teams: "فرق الموارد البشرية",
    hr_teams_desc: "استيراد جماعي للسير الذاتية، مقابلات مدعومة بالذكاء الاصطناعي، إدارة المحادثات، ودع الذكاء الاصطناعي يجد أفضل المرشحين فوراً.",
    post_job_openings: "استيراد جماعي للسير الذاتية",
    ai_recruiting_agent: "مساعد التوظيف الذكي",
    track_applications: "مقابلات فيديو ذكية",
    ...
    // Jobs Page
    find_next_opportunity: "ابحث عن فرصتك القادمة",
    browse_latest_openings: "تصفح أحدث الوظائف من أفضل الشركات",
    search_jobs: "البحث عن وظائف...",
    location: "الموقع",
    all_locations: "كل المواقع",
    job_type: "نوع الوظيفة",
    all_job_types: "كل الأنواع",
    full_time: "دوام كامل",
    part_time: "دوام جزئي",
    contract: "عقد",
    internship: "تدريب",
    ...
    onsite: "في الموقع",
    search: "بحث",
    jobs_found: "تم العثور على {count} وظيفة",
    no_jobs_found: "لم يتم العثور على وظائف",
    try_different_filters: "جرب تعديل فلاتر البحث",
    salary_not_specified: "الراتب غير محدد",
    up_to: "حتى",
    ...
    info_we_collect_desc: "نجمع المعلومات التي تقدمها لنا مباشرة، مثل:",
    personal_info_item: "المعلومات الشخصية (الاسم، البريد الإلكتروني، رقم الهاتف)",
    cv_data_item: "بيانات السيرة الذاتية",
    education_work_item: "الخلفية التعليمية والخبرة العملية",
    skills_interests_item: "المهارات والاهتمامات المهنية",
    how_we_use: "2. كيف نستخدم معلوماتك",
    how_we_use_desc: "نستخدم المعلومات التي نجمعها من أجل:",
    career_matching_item: "تقديم خدمات مطابقة المسار المهني والتوصية بالوظائف",
    process_cv_item: "معالجة وتخزين طلبات السيرة الذاتية",
    communicate_item: "التواصل معك بشأن الفرص",
    improve_services_item: "تحسين خدماتنا وتجربة المستخدم",
    data_retention: "3. الاحتفاظ بالبيانات",
    data_retention_desc: "نحتفظ بمعلوماتك الشخصية لمدة 12 شهرًا من تاريخ التقديم، أو حتى تطلب الحذف، أيهما يأتي أولاً.",
    your_rights: "4. حقوقك",
    your_rights_desc: "بموجب لوائح حماية البيانات في الكويت، لديك الحق في:",
    access_info_item: "الوصول إلى معلوماتك الشخصية",
    correct_info_item: "تصحيح المعلومات غير الدقيقة",
    delete_data_item: "طلب حذف بياناتك",
    export_data_item: "تصدير بياناتك بتنسيق قابل للنقل",
    security: "5. الأمان",
    security_desc: "نطبق تدابير تقنية وتنظيمية مناسبة لحماية معلوماتك الشخصية من الوصول غير المصرح به أو التعديل أو الكشف أو التدمير.",
    contact_us: "6. اتصل بنا",
    contact_privacy_desc: "إذا كانت لديك أسئلة حول سياسة الخصوصية هذه، يرجى الاتصال بـ support@careerly.com.",
    
    // Terms of Service
    terms_of_service_title: "شروط الخدمة",
    acceptance_of_terms: "1. قبول الشروط",
    acceptance_desc: "باستخدام Wathefni AI، فإنك تقبل وتوافق على الالتزام بشروط وأحكام هذه الاتفاقية.",
    use_license: "2. ترخيص الاستخدام",
    use_license_desc: "يُمنح الإذن باستخدام Wathefni AI مؤقتًا للعرض الشخصي غير التجاري فقط.",
    data_usage: "3. استخدام البيانات",
    data_usage_desc: "تتم معالجة سيرتك الذاتية ومعلوماتك الشخصية لأغراض مطابقة المسار المهني والتوصية بالوظائف. يتم الاحتفاظ بالبيانات لمدة 12 شهرًا ويمكن الوصول إليها فقط من قبل الموظفين المصرح لهم.",
    privacy_section: "4. الخصوصية",
    privacy_section_desc: "خصوصيتك مهمة بالنسبة لنا. يرجى مراجعة سياسة الخصوصية الخاصة بنا، والتي تحكم أيضًا استخدامك للخدمة.",
    contact_information: "5. معلومات الاتصال",
    contact_terms_desc: "إذا كانت لديك أي أسئلة حول شروط الخدمة هذه، يرجى الاتصال بـ support@careerly.com.",
    ...
    department: "القسم",
    posted: "تاريخ النشر",
    you_have_applied: "لقد تقدمت بالفعل لهذه الوظيفة",
    apply_for_job: "التقديم لهذه الوظيفة",
    your_email: "بريدك الإلكتروني",
    your_email_placeholder: "you@example.com",
    make_sure_cv_uploaded: "تأكد من تحميل سيرتك الذاتية أولاً",
    cover_letter: "رسالة التغطية (اختياري)",
    cover_letter_placeholder: "أخبرنا لماذا أنت مهتم بهذا المنصب...",
    submit_application: "إرسال الطلب",
    submitting: "جاري الإرسال...",
    application_submitted: "تم إرسال الطلب!",
    application_success_msg: "تم إرسال طلبك بنجاح. سنتواصل معك قريبًا!",
    close: "إغلاق",
