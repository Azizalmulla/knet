...
export const COMPANY_NAME = "Wathefni AI"
export const FORM_DESCRIPTION = "Wathefni AI CV Builder and Upload Platform"
      ...
      switch (field.type) {
        ...
        case "rating":
          ...
          fieldSchema = z
            ...
            .pipe(z.number().min(field.range[0], rangeErrorMessage).max(field.range[1], rangeErrorMessage))
          break
        case "select":
